...
def _build_tavily_system_prompt(prompt_version: str) -> str:
    return (
        ...
        "3. TEXTURA DE SUELO (contenido_arena, contenido_arcilla): la textura fisica de un "
        "suelo NO se modifica a escala de parcela. Esta TERMINANTEMENTE PROHIBIDO usar los "
        "verbos 'aumentar', 'incrementar', 'elevar', 'agregar' o 'anadir' referidos a arena o "
        "arcilla. Redacta SIEMPRE una accion de manejo indirecto directamente: incorporar "
        "materia organica para mejorar estructura y retencion, labranza minima para conservar "
        "agregados, cobertura vegetal (mulch), y riego adaptado a la textura actual (goteo en "
        "suelos arenosos, surcos en arcillosos). No expliques que la textura no se puede "
        "cambiar; simplemente da la practica de manejo.\n"
